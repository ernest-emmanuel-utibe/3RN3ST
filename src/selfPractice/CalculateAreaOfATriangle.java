...
public class CalculateAreaOfATriangle {
    public static void main(String[] args) {
        ...
        while(base <= 0) {
            System.out.println("That is invalid. Please input the base of the triangle (in inches): ");
        ...
        while(height <= 0) {
            System.out.print("That is invalid. Please input the height of the triangle (in inches): ");
